...
public class lorenzOrbit_Eau2 : MonoBehaviour {
	...
	void Update () {
		...
		if (RissetManager.hasRestarted == true) {
			...
			this.transform.Find ("Sphere_Eau2").GetComponent<ShepardRissetBarberpole_Eau2> ().reloadInputWave ();

			//RissetManager.hasRestarted = false;
		}

		dt = 0.11f/3f * Time.deltaTime;
