...
public class ShepardRissetBarberpole_Eau1 : MonoBehaviour
{
    // Methodes du plugin

    [DllImport("BarberPoleFilter_UnityPlugin_Eau1")]
    ...
    public InputWaveFiles inputWaveFile = InputWaveFiles.Water;
...
//#endif
		...
		filePath = get_currentFilePath(inputWaveFile); Debug.Log (filePath);
