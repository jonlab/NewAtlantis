...
public class ShepardRissetBarberpole_Eau3 : MonoBehaviour
{
    // Methodes du plugin

    [DllImport("BarberPoleFilter_UnityPlugin_Eau3")]
	...
	public InputWaveFiles inputWaveFile = InputWaveFiles.HydroWon;
