...
public class NA_Simple_CurveMaker : MonoBehaviour
{
    ...
    public void StartCurveMaker(int nbP, int nbC, int ampli,Material mat)
    {
        ...
        nbCircles = nbC;
        amplitude = ampli;
        Material instantiateMat = Material.Instantiate(mat);
        Color rdColor = new Color(Random.Range(0,1.0f), Random.Range(0, 1.0f), Random.Range(0, 1.0f), Random.Range(0, 1.0f));

        instantiateMat.SetColor("_MainColor",rdColor);
        material = instantiateMat;
    }
