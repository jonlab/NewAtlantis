	 ...
	 _RimPower("Rim Power",Range(0.1,10)) = 3.0
	   ...
	   SubShader {
        ...
        Tags { "LightMode" = "ForwardBase" }
          ...
          // float3 rim = dot(viewDirection ,normalDirection);
           float3 rimLighting = 1 - saturate(dot(normalize(viewDirection) ,normalDirection));
             // float3 rimLighting = dot(viewDirection ,normalDirection);
           // float3 rimLighting = 1 - saturate(dot(normalize(viewDirection) ,normalDirection));
