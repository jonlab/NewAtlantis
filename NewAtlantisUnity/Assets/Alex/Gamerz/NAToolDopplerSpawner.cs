...
public class NAToolDopplerSpawner : NAToolBase
{
    ...
    public string objectName = "cube";// TEST 
    ...
    void SpawnObject(string name, NetworkViewID viewID, Vector3 location, Vector3 forward, Vector3 color)
    {
        ...
        else if (name.Contains("dopplertrunk"))
        {
            Debug.LogError("ADD DOPPLER TRUNK");
