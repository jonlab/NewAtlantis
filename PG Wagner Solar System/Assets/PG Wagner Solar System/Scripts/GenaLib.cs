...
using System.Collections;
	...
	Hence, the first hexagram is unstable and its number is placed into the public integer variable "hex[0]."
	Then, the old in and yang are converted to new, and the new number of a subsequent hexagram is put into 
	public variable "hex[1]".  If the first hexagram contained no old yin or yang, it is said to be "not moving" 
	...
	in the public interger variables "hex[0]" and "hex[1]."°°°  */ 
